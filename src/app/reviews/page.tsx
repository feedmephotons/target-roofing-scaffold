...
const reviews = [
  {
    name: 'Stationagent Jules',
    date: 'Feb 2025',
    source: 'Google',
    text: 'Great service. Office staff was very helpful especially Kim.',
  },
  {
    name: 'John',
    date: 'Feb 2025',
    source: 'Google',
    text: "Target roofing was on time and on point with the service work there performed at my residence! If you need any service work or re-roof work done there the only choice!",
  },
  {
    name: 'Kaitlyn Karpuszka',
    date: 'Jun 2024',
    source: 'Google',
    text: 'Great experience and great people! Was extremely helpful through the process! 10/10! Got recommended tremendously by Matt O\'Berski and loved it!',
  },
  {
    name: 'Kaleb Gerald',
    date: 'Feb 2025',
    source: 'Google',
    text: 'Target Roofing offers great quality service at a great price !!',
  },
  {
    name: 'Amy Blocker',
    date: 'Jun 2024',
    source: 'Google',
    text: 'Target Roofing should be your first choice for a roofing company. They are very professional, knowledgeable and their work speaks for itself. Great company.',
  },
  {
    name: 'Bill Roberts',
    date: 'Jan 2025',
    source: 'Google',
    text: 'Amazing service! I contacted them after seeing what damage hurricane had done to my roof and Target Roofing was out to get to work on it the following day. Great service, customer service. Highly recommended!',
  },
  {
    name: 'Walter Doran',
    date: 'Jul 2024',
    source: 'Google',
    text: 'Excellent service and quality ...no job too big handles our condo association to complete satisfaction',
  },
  {
    name: 'Joel Francis Rico',
    date: 'Dec 2024',
    source: 'Google',
    text: 'Spoke with Brent, very professional great to work with! Highly recommended!',
  },
  {
    name: 'Damon Daniels',
    date: 'Jun 2024',
  ...
  },
  {
    ...
    date: '',
    source: 'Google',
    text: "I always know that I can count on the team at Target Roofing! Casey, Trey, and Shannon are all great people to have representing the company in the community and are always good for a friendly smile and a warm 'Hello'. More specifically, I always give Trey's information whenever I hear someone in need of a roof repair.",
  },
  {
    name: 'Katie Edmunds',
    date: '',
    source: 'Google',
    text: 'Having worked with other, well-known roofing companies around SWFL, Target Roofing is, by far, second to none. Every stage of the process was seamless and professional.',
  },
  {
    name: 'Laurie H',
    date: '',
    source: 'Google',
    text: 'Wow so impressed by Target Roofing and all of their staff! Such a great company to work with.',
  },
  {
    name: 'Alex P.',
    date: '',
    source: 'Google',
    text: 'Target Roofing and Sheet Metal did an amazing job on my roof and the service is incredible, the man who assisted me, Trevor Hume, truly was amazing.',
  },
  {
    name: 'Danielle Beach',
    date: '',
    source: 'Facebook',
    text: 'Target Roofing does great work, gives back to the community, and is run by great people!',
  },
  {
    name: 'Backyard Builders',
    date: '',
    source: 'Google',
    text: "Matt is fantastic. Had Target help us out in a pinch when I couldn't get anyone else to assist.",
  },
  {
    name: 'Lee Wood',
    date: '',
    source: 'Google',
    text: 'Work with Matt at this place!!! They got you covered for all your roofing needs.',
  },
  {
    name: 'Arturo De los Reyes Gavilan',
    date: '',
    source: 'Google',
    text: 'Target Roofing was professional, efficient, and reliable. They provided clear recommendations, completed the job quickly, and left my property clean.',
  },
  {
    name: 'Kathy Biggs',
    date: '',
    source: 'Google',
    text: 'Target Roofing has been very prompt in responding and scheduling.',
  },
  {
    name: 'Dayan Delgado',
    date: '',
    source: 'Google',
    text: 'At the moment I needed a roofing company the most, one that offered the best price to redo my roof, I found them. I would hire them again without hesitation.',
  },
]
